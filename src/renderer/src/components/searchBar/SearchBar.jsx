...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[24px] border border-slate-200 bg-white p-4 shadow-[0_16px_40px_rgba(15,23,42,0.06)] md:flex-row md:items-center md:justify-between sm:p-5 dark:border-slate-800 dark:bg-slate-950 dark:shadow-none">
      ...
      <button
        ...
        className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-2xl bg-[#00b09b] px-5 py-3 text-sm font-semibold text-white shadow-[0_14px_28px_rgba(0,176,155,0.25)] transition-transform hover:-translate-y-0.5"
      >
